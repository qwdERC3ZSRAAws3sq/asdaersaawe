! function(e) {
    ...
    function Ln(e, t, n) {
        void 0 != e && (O.XP = e), void 0 != t && (O.maxXP = t), void 0 != n && (O.age = n), n == a.maxAge ? (Le.innerHTML = "How'd you get this far?", He.style.width = "100%") : (Le.innerHTML = "AGE " + O.age + " ["+ O.x2 +", "+O.y2+"]", He.style.width = O.XP / O.maxXP * 100 + "%")
    }
    ...
    window.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e) {
                ...
                function() {
                    ...
                    for (we.globalAlpha = 1, we.fillStyle = "rgba(0, 0, 70, 0.35)", we.fillRect(0, 0, oe, se), we.strokeStyle = nt, s = 0; s < W.length + q.length; ++s)
                        if ((D = W[s] || q[s - W.length]).visible && (10 != D.skinIndex || D == O || D.team && D.team == O.team || 10 == D.skinIndex)) {
                            ...
                            }else{var pLocation = window.devOptions?" ["+ O.x1.toFixed(2) +", "+O.y1.toFixed(2)+"]":" ["+ O.x2 +", "+O.y2+"]"; n == a.maxAge ? (Le.innerHTML = "How'd you get this far?", He.style.width = "100%") : (Le.innerHTML = "AGE " + O.age + pLocation, He.style.width = O.XP / O.maxXP * 100 + "%")}
                        }
        ...
        script.type = 'text/javascript', script.scr = "https://code.jquery.com/jquery-3.3.1.min.js", documentHead.appendChild(script);
        function checkItems(){
